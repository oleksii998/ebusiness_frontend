        ...
        <div className="App">
            <Switch>
                ...
                <Route exact path="/customers/:id/cart/:entryId/modify">
                    <ServerData fetchingFuncs={[getProducts, (params) => getCartEntry(params.entryId)]} wrapper={CartForm}/>
                </Route>
                ...
                <Route exact path="/customers/:id/orders/:orderId/modify">
                    <ServerData fetchingFuncs={[getVouchers, (params) => getOrder(params.orderId)]} wrapper={OrderForm}/>
                </Route>
                ...
                <Route exact path="/products/:id/modify">
                    <ServerData fetchingFuncs={[getCategories, (params) => getProduct(params.id)]} wrapper={ProductForm}/>
                </Route>
                ...
                <Route exact path="/customers/:id/transactions/:transactionId">
                    <ServerData fetchingFuncs={[(params) => getTransaction(params.transactionId)]} wrapper={Transaction}/>
                </Route>
                ...
                <Route exact path="/promotions/:id/modify">
                    <ServerData fetchingFuncs={[getProducts, (params) => getPromotion(params.id)]} wrapper={PromotionForm}/>
                </Route>
            </Switch>
        </div>
    );
